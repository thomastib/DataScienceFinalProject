...
<!-- -->
```
    1.  Generate a spatial weight matrix

    2.  Combine the spatial weight with the dependent variable to generate a new independent variable

    3.  Run regression on the result
